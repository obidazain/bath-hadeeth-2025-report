...
interface IntegralInnovationSlideProps {
  onNavigate?: (slideIndex: number) => void;
}

export function IntegralInnovationSlide({ onNavigate }: IntegralInnovationSlideProps) {
  return (
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <p className="text-xl sm:text-2xl leading-relaxed text-gray-700" dir="ltr" style={{ textAlign: 'justify' }}>
              The limitations of our human and financial resources, combined with the intensity of market competition, push us to adopt our own maxim: "Pressure breeds innovation," and to produce effective and unconventional solutions.
            </p>
          </motion.div>
        </div>
