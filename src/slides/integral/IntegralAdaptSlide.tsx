...
interface IntegralAdaptSlideProps {
  onNavigate?: (slideIndex: number) => void;
}

export function IntegralAdaptSlide({ onNavigate }: IntegralAdaptSlideProps) {
  return (
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <p className="text-xl sm:text-2xl leading-relaxed text-gray-700" dir="ltr" style={{ textAlign: 'justify' }}>
              Technical tools are increasingly dominating the media industry. This requires a high level of adaptability and the ability to anticipate, take risks, experiment, and pioneer new frontiers.
            </p>
          </motion.div>
        </div>
